...
//error_reporting(0);
  ...
  if (isset($_POST["submit"])) {
    ...
    $query = "SELECT * FROM librarian WHERE user = '$user' && password= '$password'";
    ...
    if($total >0){
           ...
           if ($row['status']==1) {
               ...
               if ($row['role']==1) {
                ...
                echo "<h3 style='color:red;'><center>This account in not active <br> Contact with the authority</center></h3>";
           }
    }else{
