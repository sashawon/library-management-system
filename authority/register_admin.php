...
<?php
if (isset($_POST['librarian_registar'])) {
    $fname=$_POST['fname'];
    $lname=$_POST['lname'];
    $email=$_POST['email'];
    $user=$_POST['user'];
    ...
    $sql= "INSERT INTO `librarian`(`fname`, `lname`, `email`, `user`, `password`, `phone`, `role`, `status`) VALUES ('$fname','$lname','$email','$user','$password','$phone','$role',0)";
            ...
            <div class="panel mb-none">
                <div class="panel-content bg-scale-0">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-md">
                            <span class="input-with-icon">
                                <input type="text" class="form-control" placeholder="User ID" name="user"  required>
                                <i class="fa fa-user"></i>
                            </span>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="btn btn-primary btn-block" type="submit" name="librarian_registar" value="Register">
                        </div>
                    </form>
                </div>
            </div>
