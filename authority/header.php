                        ...
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="has-child-item close-item">
                                    <a><i class="fa fa-cubes" aria-hidden="true"></i><span>Admin/Moderator</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li><a href="register_admin.php">Add Admin/Moderator</a></li>
                                        <li><a href="admin.php"><span>Admin/Moderator List</span></a></li>
                                    </ul>
                                </li>
                                <!--STUDENT LIST-->
                                <li class="has-child-item close-item">
                                ...
                                <!--ISSUE BOOK-->
                                <li><a href="issue_books.php"><i class="fa fa-users" aria-hidden="true"></i><span>Issue Books</span></a></li>
                                <!--RETURN BOOK-->
                                <li><a href="return_books.php"><i class="fa fa-users" aria-hidden="true"></i><span>Return Books</span></a></li>
