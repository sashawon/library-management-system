            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?php echo 'Welcome '.$_SESSION['fname'].' '.$_SESSION['lname']; ?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <!--ALL BOOKS-->
                                <li><a href="allbooks.php"><i class="fa fa-book" aria-hidden="true"></i><span>All Books</span></a></li>
